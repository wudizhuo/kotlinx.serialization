...
fun <E> serializerBySerialDescClassname(className: String): KSerializer<E> = SerialCache.lookupSerializer(className)

fun <E> serializerByClass(klass: KClass<*>): KSerializer<E> = SerialCache.lookupSerializer(mapJavaClassNameToKotlin(klass.java.canonicalName ?: ""), klass)
